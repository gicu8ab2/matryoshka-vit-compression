...
# Script to evaluate all nested ViT models from MRL training
# Usage: ./evaluate_all_nested_models.sh [dataset] [net_type] [patch_size]
...
echo ""
echo "To view results in TensorBoard, run:"
