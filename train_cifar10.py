...
from MRL import Matryoshka_CE_Loss, MRL_Entire_Transformer

# parsers
parser = argparse.ArgumentParser(description='Matryoshka-ViT CIFAR10 Training')
...
parser.add_argument('--mrl_dims', default='32,128,256,512', type=str, help='comma-separated list of embedding dimensions for MRL')
